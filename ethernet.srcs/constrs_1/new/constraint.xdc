...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { ps2_data }]; #IO_0_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { ja[1] }]; #IO_L4P_T0_15 Sch=ja[2]
#set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { ps2_clk }]; #IO_L4N_T0_15 Sch=ja[3]
...
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { ETH_RXD[4] }]; #IO_L13N_T2_MRCC_15 Sch=eth_rx_dv
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { ETH_RXD[0] }]; #IO_L21N_T3_DQS_A18_15 Sch=eth_rxd[0]
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { ETH_RXD[1] }]; #IO_L16P_T2_A28_15 Sch=eth_rxd[1]
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { ETH_RXD[2] }]; #IO_L21P_T3_DQS_15 Sch=eth_rxd[2]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { ETH_RXD[3] }]; #IO_L18N_T2_A23_15 Sch=eth_rxd[3]
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { ETH_RXD[5] }]; #IO_L20N_T3_A19_15 Sch=eth_rxerr
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { ETH_TX_CLK }]; #IO_L13P_T2_MRCC_15 Sch=eth_tx_clk
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { ETH_TXD[4] }]; #IO_L19N_T3_A21_VREF_15 Sch=eth_tx_en
...
create_clock -add -name ether_tx_clk -period 40.00 [get_ports { ETH_TX_CLK }];


# Output Delay Constraint
set_output_delay -clock ether_tx_clk -max 11.000 [get_ports {ETH_TXD[*]}];
set_output_delay -clock ether_tx_clk -min 0.000  [get_ports {ETH_TXD[*]}];


create_clock -add -name ether_rx_clk -period 40.00 [get_ports { ETH_RX_CLK }];

# Output Delay Constraint
set_input_delay -clock ether_rx_clk -max 31.000 [get_ports {ETH_RXD[*]}];
set_input_delay -clock ether_rx_clk -min 10.000  [get_ports {ETH_RXD[*]}];
